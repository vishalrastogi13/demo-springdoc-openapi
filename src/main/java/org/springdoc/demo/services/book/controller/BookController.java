...
public class BookController {
	...
	@Operation(summary = "Get a book by its id", security = {@SecurityRequirement(name = "api")})
	@ApiResponses(value = {
	...
	@Operation(summary = "Get all books", security = {@SecurityRequirement(name = "api")})
	@ApiResponses(value = {
